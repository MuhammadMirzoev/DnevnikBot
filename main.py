...
load_dotenv()
TOKEN = '5684731645:AAGAeQaF011Vky9DDi9S-v42hNQyU7Bfjls'
...
def start_message(message):
    # bot.send_photo(message.chat.id, "Dnevnik.png")
...
def buttons(message):
    ...
    if message.text == '❓Связаться с разработчиками':
        ...
        bot.send_message(message.chat.id, text='Если вы столкнулись с ошибкой или хотите указать свои пожелания,'
                                               ' напишите админам: @mr_window или @umar2k7.', reply_markup=markup)
...
def list_of_classes(message):
    ...
    # вывод сообщения об ошибке в случае некоррекного ввода данных / неверного вызова
        ...
        markup.add('✅Назад в главную')
        bot.send_message(message.chat.id, 'К сожалению, вы не состоите ни в одном классе.',
                         reply_markup=markup)
